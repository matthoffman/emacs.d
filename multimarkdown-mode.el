...
(defcustom multimarkdown-command "multimarkdown"
  "Command to run MultiMarkdown."
  :group 'multimarkdown
  :type 'string)

(defcustom multimarkdown-xhtml-command "multimarkdown -t html"
  "Command to generate XHTML output from MultiMarkdown"
  :group 'multimarkdown
  :type 'string)

(defcustom multimarkdown-latex-command "multimarkdown -t latex"
